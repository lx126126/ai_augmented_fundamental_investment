...
SAMPLE_QUARTERLY = [
    (None, "营业总收入（亿元）", [850, 820, 870, 856, 840, 830, 860, 856]),
    (None, "营业收入（亿元）", [850, 820, 870, 856, 840, 830, 860, 856]),
    (None, "归母净利润（亿元）", [148, 135, 155, 152, 145, 138, 158, 152]),
    (None, "货币资金（季末，亿元）", [1580, 1590, 1600, 1620, 1630, 1650, 1660, 1680]),
    (None, "存货（季末，亿元）", [135, 138, 140, 130, 132, 135, 140, 138]),
    ...
    (None, "营业总收入同比 %", [8.1, 7.2, 6.5, 5.8, -1.2, 1.2, -1.1, 0.0]),
    (None, "归母净利润同比 %", [9.2, 8.0, 7.1, 6.0, -2.0, 2.2, 1.9, 0.0]),
    (None, "经营现金流净额同比 %", [5.0, 4.1, 3.8, 3.2, -2.1, 4.8, 3.8, 0.0]),
]
